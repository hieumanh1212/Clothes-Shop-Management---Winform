...
{
    public partial class FormMain_NhanVienBanHang : Form
    {
        ...
        public FormMain_NhanVienBanHang(string MANHANVIEN)
        {
            InitializeComponent();
        ...
        private void FormMain_NhanVienBanHang_SizeChanged(object sender, EventArgs e)
        {
            if (checkForm != null)
                checkForm.Dock = DockStyle.Fill;
